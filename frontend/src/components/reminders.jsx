    ...
    <Card className="bg-zinc-900 border-zinc-800 p-6 w-full max-w-lg mx-auto shadow-2xl rounded-lg">
      <div className="flex justify-between items-center mb-6">
        <button
          ...
          className="text-white text-md font-medium shadow-xl px-3 py-1 bg-gray-700 rounded-md hover:bg-gray-600 transition"
        >
          &lt;
        </button>
        ...
        <button
          ...
          className="text-white text-md font-medium px-3 py-1 bg-gray-700 rounded-md hover:bg-gray-600 transition"
        >
          &gt;
        </button>
      </div>
